        ...
        {notifications.length === 0 ? (
          ...
          <div className="space-y-4">
            {notifications.map((notification) => (
              <Card
                key={notification.id}
                className={`p-6 transition-all ${notification.is_read ? "bg-slate-800/50 border-slate-700" : "bg-indigo-900/20 border-indigo-700"}`}
              >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      {!notification.is_read && (
                        <span className="px-2 py-1 bg-indigo-500 text-white text-xs rounded-full">New</span>
                      )}
                    </div>
